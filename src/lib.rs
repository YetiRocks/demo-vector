//! demo-vector — Phase 48 static-crate entry point.
//!
...
pub fn service() -> Box<dyn Service> {
    Box::new(DemoVectorService)
}

struct DemoVectorService;

impl Service for DemoVectorService {
    ...
    fn schemas(&self) -> Vec<&'static str> {
        vec![include_str!("../schemas/vector.graphql")]
    }
